...
## 📟 Embedded Programming
 ...
 - ESP32 C3
 - Teensy 4.0, 4.1
   - [Virginia Motorsports](https://www.virginiamotorsportseducation.org/) Electrical Team Mentor (August 2024 - Present): programmed a Teensy 4.0 with PlatformIO to control a J1772 charger and handle CAN communication with a [TC Charger](https://evolveelectrics.com/products/uhf-6-6-kw-charger-w-canbus) and custom BMS

## 💻 Computer Architecture
 - Designed a [32-bit RISC-V CPU in Intel Quartus II with Verilog](https://github.com/RedHotRojo/32-Bit-RISC-V-CPU) (Spring 2026)
